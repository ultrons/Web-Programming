...
var testModule = (function() {
  ...
  // Test1
  function cs142MakeMultiFilterTest() {
    // ********************* Test cs142filter
  ...
  function cs142TemplateProcessorTest () {
  ...
  cs142MakeMultiFilterTest();
  cs142TemplateProcessorTest();
  cs142NameSpaceTest();
...
window.onload = function () {
    document.getElementById("cs142p1").innerHTML = testModule.p1Message;
    document.getElementById("cs142p2").innerHTML = testModule.p2Message;
    document.getElementById("cs142p3").innerHTML = testModule.p3Message;
};
